...
const COMMANDS = {
  ...
  whoami() {
    ...
    printLine(`Currently on contract at CodeWisp (YC W26). Building production AI infra.`);
  },
  projects() {
  ...
  experience() {
    printLine(`2026—present  Contract AI/ML Engineer @ CodeWisp (YC W26)`);
    printLine(`2025          Data Analyst Intern @ Elevate Labs`);
    printLine(`2022—2026     B.Tech IT, SKCET Coimbatore`);
  },
  contact() {
